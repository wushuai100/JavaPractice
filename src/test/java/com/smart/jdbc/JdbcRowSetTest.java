...
/**
 * Created by wushuai3 on 2016/8/7.
 */
public class JdbcRowSetTest {
    ...
    public void initParam(String paramFile)throws Exception
    {
        ...
        props.load(new FileInputStream("D:/JavaProject/SpringAop/src/test/"+paramFile));
        driver = props.getProperty("driver");
        url = props.getProperty("url");
        user = props.getProperty("user");
        pass = props.getProperty("pass");
    }
    public void updatge(String sql) throws Exception{
    ...
    public static void main(String[] args) throws Exception{
        ...
        jt.initParam("mysql.txt");
        jt.updatge("select * from student_table");
    }
}
